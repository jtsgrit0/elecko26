...
void main() async {
  ...
  try {
    ...
    await outputFile.writeAsString(JsonEncoder.withIndent('  ').convert(firebaseData));
    ...
    print('1. Firebase 콘솔 접속: https://console.firebase.google.com/project/elecko26-536e0/firestore');
    print('2. "데이터 가져오기" 클릭');
    ...
    for (final entry in firebaseData.entries) {
      ...
      await docFile.writeAsString(JsonEncoder.withIndent('  ').convert(entry.value));
    }
