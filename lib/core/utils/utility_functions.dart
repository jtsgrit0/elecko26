...
String getParentRegion(String district) {
  ...
  const districtToRegion = <String, String>{
    // 서울
    '서울': '서울특별시',
    '종로': '서울특별시', '중구': '서울특별시', '용산': '서울특별시', '성동': '서울특별시', '광진': '서울특별시',
    ...
    '강원': '강원도', '양양': '강원도', '홍천': '강원도', '춘천': '강원도', '원주': '강원도',
    '충청북': '충청북도', '충북': '충청북도', '청주': '충청북도', '충주': '충청북도', '제천': '충청북도',
    '충청남': '충청남도', '충남': '충청남도', '천안': '충청남도', '아산': '충청남도', '논산': '충청남도',
    '전라북': '전라북도', '전북': '전라북도', '전주': '전라북도', '익산': '전라북도', '군산': '전라북도',
    '전라남': '전라남도', '전남': '전라남도', '목포': '전라남도', '여수': '전라남도', '순천': '전라남도',
    '경상북': '경상북도', '경북': '경상북도', '포항': '경상북도', '구미': '경상북도', '경주': '경상북도', '안동': '경상북도',
    '경상남': '경상남도', '경남': '경상남도', '창원': '경상남도', '김해': '경상남도', '진주': '경상남도', '거제': '경상남도',
    '제주': '제주특별자치도',
  };
