...
String getParentRegion(String district) {
  ...
  const districtToRegion = <String, String>{
    // 서울특별시
    '서울': '서울특별시', '종로': '서울특별시', '용산': '서울특별시', '성동': '서울특별시', '광진': '서울특별시',
    '동대문': '서울특별시', '중랑': '서울특별시', '성북': '서울특별시', '강북': '서울특별시', '도봉': '서울특별시',
    '노원': '서울특별시', '은평': '서울특별시', '서대문': '서울특별시', '마포': '서울특별시', '양천': '서울특별시',
    '강서': '서울특별시', '구로': '서울특별시', '금천': '서울특별시', '영등포': '서울특별시', '동작': '서울특별시',
    '관악': '서울특별시', '서초': '서울특별시', '강남': '서울특별시', '송파': '서울특별시', '강동': '서울특별시',

    // 부산광역시
    '부산': '부산광역시', '해운대': '부산광역시', '영도': '부산광역시', '연제': '부산광역시', '수영': '부산광역시', '기장': '부산광역시',
    '부산진': '부산광역시', '동래': '부산광역시', '금정': '부산광역시', '사하': '부산광역시', '사상': '부산광역시', '강서구': '부산광역시',
    '수영구': '부산광역시', '연제구': '부산광역시', '사상구': '부산광역시',

    // 대구광역시
    '대구': '대구광역시', '수성': '대구광역시', '달서': '대구광역시', '달성': '대구광역시', '군위': '대구광역시',
    '남구': '대구광역시', '북구': '대구광역시', '서구': '대구광역시', '동구': '대구광역시',

    // 인천광역시
    '인천': '인천광역시', '연수': '인천광역시', '남동': '인천광역시', '부평': '인천광역시', '강화': '인천광역시',
    '계양': '인천광역시', '미추홀': '인천광역시', '옹진': '인천광역시',

    // 광주광역시
    '광주': '광주광역시', '광산': '광주광역시', '남구청': '광주광역시', '북구청': '광주광역시', '동구청': '광주광역시', '서구청': '광주광역시',

    // 대전광역시
    '대전': '대전광역시', '유성': '대전광역시', '대덕': '대전광역시',
    ...
    // 경기도
    '경기': '경기도', '수원': '경기도', '용인': '경기도', '고양': '경기도', '화성': '경기도', '성남': '경기도',
    '부천': '경기도', '남양주': '경기도', '안산': '경기도', '평택': '경기도', '안양': '경기도', '시흥': '경기도',
    '파주': '경기도', '김포': '경기도', '의정부': '경기도', '하남': '경기도', '군포': '경기도', '오산': '경기도',

    // 강원특별자치도
    '강원': '강원도', '양양': '강원도', '홍천': '강원도', '춘천': '강원도', '원주': '강원도', '강릉': '강원도', '동해': '강원도',

    // 충청북도
    '충청북': '충청북도', '충북': '충청북도', '청주': '충청북도', '충주': '충청북도', '제천': '충청북도',

    // 충청남도
    '충청남': '충청남도', '충남': '충청남도', '천안': '충청남도', '아산': '충청남도', '논산': '충청남도', '당진': '충청남도', '공주': '충청남도',

    // 전라북도
    '전라북': '전라북도', '전북': '전라북도', '전주': '전라북도', '익산': '전라북도', '군산': '전라북도', '익산시': '전라북도',

    // 전라남도
    '전라남': '전라남도', '전남': '전라남도', '목포': '전라남도', '여수': '전라남도', '순천': '전라남도', '나주': '전라남도', '광양': '전라남도',

    // 경상북도
    '경상북': '경상북도', '경북': '경상북도', '포항': '경상북도', '구미': '경상북도', '경주': '경상북도', '안동': '경상북도', '경산': '경상북도',

    // 경상남도
    '경상남': '경상남도', '경남': '경상남도', '창원': '경상남도', '김해': '경상남도', '진주': '경상남도', '거제': '경상남도', '양산': '경상남도',
